...
if __name__ == "__main__":
    ...
    try:
        ...
        header_params = ",".join([f"Friction_{i}" for i in range(dof)]) + "," + ",".join([f"Armature_{i}" for i in range(dof)])
        header = f"Iteration,Best_Cost,{header_params}\n"
        ...
        while not es.stop():
            ...
            with open(log_file_path, "a") as f:
                params_str = ",".join(map(str, best_x))
                f.write(f"{iteration},{best_f},{params_str}\n")
